...
class GymFetchEnv(fetch_env.FetchEnv, EzPickle):
    def __init__(self, action, reward_type='sparse', n_substeps=20, distance_threshold=0.05):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
            'robot0:slide2': 0.0,
...
class GymFetchFloorEnv(fetch_env.FetchFloorEnv, EzPickle):
    def __init__(self, action, reward_type='dense', n_substeps=20, distance_threshold=0.05):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
            'robot0:slide2': 0.0,
        ...
        if action == "slide":
            ...
            gripper_extra_height = 0.0  # modified
            target_offset = 0.0
            obj_range = 0.15
            target_range = 0.15

        target_in_the_air = 0.5 if action in ['pick-place'] else False
        block_gripper = action in ['reach', 'slide', 'push']  # modified
